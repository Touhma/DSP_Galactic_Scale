...
public class GSPlanetVeins
{
    ...
    public EVeinType[] types;
    public int count;
    
}

public virtual void GenerateVeins(GSPlanet gsPlanet, bool sketchOnly)
{
    ...
    lock (planet)
    {
        ...
        for (int num18 = 0; num18 < veinVectorCount; num18++)
        {
            ...
            int num26 = Mathf.RoundToInt(num21 * 100000f * resourceCoef);
            if (num26 < 20)
            {
                num26 = 20;
            }
            ...
            {
                Vector3 vector5 = (tmp_vecs[num28].x * vector + tmp_vecs[num28].y * vector2) * num2point1fdivbyplanetradius;
                ...
                vein.minerCount = 0;
                float num29 = planetRawData.QueryHeight(vein.pos);
                ...
                if (planet.waterItemId == 0 || !(num29 < planet.radius))
                {
                    ...
                    planetRawData.AddVeinData(vein);
                }
            }
        }
        tmp_vecs.Clear();

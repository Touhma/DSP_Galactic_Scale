    ...
    public partial class PatchOnPlayerMove_Sail
    {
        ...
        public static bool PatchGasPlanetSailing(ref PlayerMove_Sail __instance)
        {
            ...
            if (__instance.player.sailing)
            {
                ...
                if (__instance.navigation.navigating) __instance.navigation.DetermineSailVelocity();

                __instance.uForce = VectorLF3.zero;
                var localPlanet = GameMain.localPlanet;
                var localStar = GameMain.localStar;
                if (__instance.player.warping) Assert.Null(localPlanet);
                ...
                if (__instance.player.mecha.thrusterLevel >= 3)
                {
                    ...
                    if (__instance.player.warping && __instance.player.warpCommand && localStar != null)
                        for (var index = 0; index < localStar.planetCount; ++index)
                        {
                            ...
                            if (num4 > 4000.0 + planet.realRadius) num4 = 4000.0 + planet.realRadius;
                    ...
                    {
                        if (VFInput._sailSpeedUp) __instance.warpSpeedControl += 0.008;

                        if (__instance.controller.input0.y < 0.0) __instance.warpSpeedControl -= 0.008;

                        if (__instance.warpSpeedControl > 1.0) __instance.warpSpeedControl = 1.0;

                        if (__instance.warpSpeedControl < 0.2) __instance.warpSpeedControl = 0.2;
                    }
                ...
                {
                    __instance.player.warpCommand = false;
                    if ((localPlanet == null) & flag1) UIRealtimeTip.PopupAhead("驱动引擎等级不足".Translate());
                }

                if (__instance.player.warping && !__instance.UseWarpEnergy(dt)) __instance.player.warpCommand = false;
                ...
                if (localPlanet != null)
                {
                    ...
                    if (altitude < 0)
                        __instance.player.uPosition =
                            localPlanet.uPosition + VectorLF3.unit_z * 2 * localPlanet.realRadius;
                    ...
                    if (guideRunning) vectorLf3_1 = VectorLF3.zero;
                ...
                if (__instance.input_aff_0 < 0.0) __instance.input_aff_0 = 0.0;

                if (__instance.input_aff_1 < 0.0) __instance.input_aff_1 = 0.0;

                if (__instance.input_aff_2 < 0.0) __instance.input_aff_2 = 0.0;

                __instance.input_cd += dt;
                if (__instance.input_cd > 1.0) __instance.input_cd = 1.0;
                ...
                if (__instance.navigation.navigating)
                {
                    ...
                    if (__instance.controller.input0.y > 0.0) __instance.controller.input0.y = 0.0f;
                ...
                if (vector3_1.sqrMagnitude > 0.25)
                {
                    ...
                    if (num2 != 0)
                    {
                        ...
                        if (flag2 && !__instance.player.warping)
                        {
                            ...
                            if (dvel < 7.0)
                                dvel = 7.0;
                            else if (dvel > __instance.max_acc) dvel = __instance.max_acc;

                            if (num3 + dvel > __instance.maxSailSpeed) dvel = __instance.maxSailSpeed - num3;
                    ...
                    if (!disableController) __instance.player.uVelocity += dvel1;
                }
                ...
                if (!flag3 & flag2 && !__instance.player.warping)
                {
                    ...
                    if (num2 + dvel > __instance.maxSailSpeed) dvel = __instance.maxSailSpeed - num2;
                ...
                if (__instance.input_aff_0 > 1.0) __instance.input_aff_0 = 1.0;

                var universalGravity = __instance.controller.universalGravity;
                var magnitude2 = universalGravity.magnitude;
                if (!guideRunning) __instance.uForce = universalGravity;
                ...
                if (localPlanet != null)
                {
                    ...
                    var dvel = vectorLf3_4 * num12 + vectorLf3_7.normalized * num10 + vectorLf3_1 -
                               __instance.player.uVelocity;
                    __instance.UseSailEnergy(ref dvel, 1.5);
                    if (!disableController && !guideRunning) __instance.player.uVelocity += dvel;
                    ...
                    if (num14 > 1.0 / 1000.0)
                    {
                        ...
                        if (!guideRunning) __instance.uForce += force;
                    }
                }
                ...
                if (!disableController) __instance.player.uVelocity += __instance.uForce * dt;
                ...
                if (!disableController)
                {
                    ...
                    if (__instance.player.warping) __instance.player.uPosition += __instance.currentWarpVelocity * dt;
                }
                ...
                else if (__instance.player.uPosition.x > 480000000.0) __instance.player.uPosition.x = 480000000.0;

                if (__instance.player.uPosition.y < -240000000.0)
                    __instance.player.uPosition.y = -240000000.0;
                else if (__instance.player.uPosition.y > 240000000.0) __instance.player.uPosition.y = 240000000.0;

                if (__instance.player.uPosition.z < -480000000.0)
                    __instance.player.uPosition.z = -480000000.0;
                else if (__instance.player.uPosition.z > 480000000.0) __instance.player.uPosition.z = 480000000.0;

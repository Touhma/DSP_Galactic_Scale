...
namespace GalacticScale
{
    public partial class PatchOnPlanetGrid
    {
        ...
        public static bool CalcSegmentsAcross(PlanetGrid __instance, Vector3 posR, Vector3 posA, Vector3 posB,
            ref float __result)
        {
            ...
            var num3 = Mathf.Max(1.0f / __instance.segment * 0.96f,
                Mathf.Cos(num) * (float) Math.PI * 2f / (num2 * 5f));

...
namespace GalacticScale
{
    public partial class PatchOnUIStarmapPlanet
    {
        ...
        public static void UIStarmapPlanet_OnInit_Postfix(ref GameObject ___relatedObject,
            ref UIStarmapPlanet __instance, PlanetData ___planet, ref LineRenderer ___orbitRenderer)
        {

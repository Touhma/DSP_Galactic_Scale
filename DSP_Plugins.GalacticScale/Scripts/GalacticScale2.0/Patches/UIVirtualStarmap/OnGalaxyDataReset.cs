            ...
            for (int index2 = 0; index2 < __instance._galaxyData.stars.Length; ++index2)
            {
                ...
                for (int index3 = 0; index3 < graphNode.lines.Count; ++index3)
                {
                    ...
                    if (line.index > graphNode.index)
                    {
                        ...
                        float num3 = Vector3.Distance(star1.position, star2.position);
                        float t1 = (float)(num1 * 0.25 + 0.349999994039536) / num3;
                        float t2 = (float)(1.0 - (num2 * 0.25 + 0.349999994039536) / num3);

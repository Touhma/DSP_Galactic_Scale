...
namespace GalacticScale {
    public partial class PatchOnGameMain {
        ...
        public static bool End() {
            ...
            if (GameMain.data == null) { GS2.Error("GameMain.data == null"); return false; }
            ...
            if (UIRoot.instance == null) { GS2.Error("UIRoot Instance Null"); return false; }
            UIRoot.instance.OnGameEnd();
            if (GameMain.universeSimulator == null) { GS2.Error("UniverseSimulator == null"); return false; }

...
namespace GalacticScale
{
    ...
    {
		public static void GenerateTerrain5(GSPlanet gsPlanet, double modX, double modY)
		{
			...
			for (int i = 0; i < data.dataLength; i++)
			{
				...
				data.heightData[i] = (ushort)(((double)gsPlanet.planetData.radius + hdEnd + 0.2 + t.baseHeight) * 100.0 * t.heightMulti );

...
namespace GalacticScale
{
    public static partial class VegeAlgorithms
    {
        ...
        public static void GenerateVeges1(GSPlanet gsPlanet)
        {
            ...
            int num11 = stride / 2;
            float num12 = planet.radius * 3.14159f * 2f / (data.precision * 4f);
            ...
            for (int i = 0; i < data.dataLength; i++)
            {
                ...
                float num18 = data.heightData[i] * 0.01f;
                float num19 = data.heightData[i + 1 + stride] * 0.01f;
                float num20 = data.heightData[i - 1 + stride] * 0.01f;
                float num21 = data.heightData[i + 1 - stride] * 0.01f;
                float num22 = data.heightData[i - 1 - stride] * 0.01f;
                float num23 = data.heightData[i + 1] * 0.01f;
                float num24 = data.heightData[i - 1] * 0.01f;
                float num25 = data.heightData[i + stride] * 0.01f;
                float num26 = data.heightData[i - stride] * 0.01f;
                ...
                double num40 = simplexNoise2.Noise(num15 * 0.4, num16 * 0.4, num17 * 0.4) * num7 + num8 + 0.5;

...
namespace GalacticScale
{
    public static class NebulaCompatibility
    {
        ...
        //    }
        //}
        public static Type N_LocalPlayer;

        public static Type N_SimulatedWorld;

        //public static Type N_Double3 = null;
        //public static Type N_PlayerData = null;
        public static bool Nebula;
        ...
        public static bool IsMasterClient
        {
            get
            {
                ...
                var val = (bool) N_LocalPlayer.GetProperty("IsMasterClient").GetValue(null);

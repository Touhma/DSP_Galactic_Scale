    ...
    public class GSUI {
        ...
        public bool Set(object o) {
            ...
            switch (type) {
                case "Slider":
                    if (o is string) {
                        if (float.TryParse(o as string, out float parsedResult)) {
                            o = parsedResult;
                        } else {
                ...
                case "Checkbox":
                    if (o is string) {
                        if (bool.TryParse(o as string, out bool parsedResult)) {
                            o = parsedResult;
                        } else {
                ...
                case "Combobox":
                    if (o is string) {
                        if (int.TryParse(o as string, out int parsedResult)) {
                            o = parsedResult;
                        } else {
        ...
        public static GSUI Slider(string label, float min, float val, float max, GSOptionCallback callback, bool enableFloat = false, GSOptionPostfix postfix = null) => new GSUI(label, "Slider", new GSSliderConfig() { minValue = min, maxValue = max, defaultValue = val, wholeNumbers = !enableFloat }, callback, postfix);
        ...
        public static GSUI Checkbox(string label, bool value, GSOptionCallback callback, GSOptionPostfix postfix = null, string tip = "") => new GSUI(label, "Checkbox", value, callback, postfix, tip);
        ...
        public static GSUI Combobox(string label, List<string> items, GSOptionCallback callback, GSOptionPostfix postfix = null, string tip = "") => new GSUI(label, "Combobox", items, callback, postfix, tip);
        ...
        public static GSUI Input(string label, string value, GSOptionCallback callback, GSOptionPostfix postfix = null, string tip = "") => new GSUI(label, "Input", value, callback, postfix, tip);
        ...
        public static GSUI Button(string label, string caption, GSOptionCallback callback, GSOptionPostfix postfix = null, string tip = "") => new GSUI(label, "Button", caption, callback, postfix, tip);

        private static GSOptionCallback CreateDefaultCallback(string id, GSOptionCallback callback = null) {
            return (o) => {

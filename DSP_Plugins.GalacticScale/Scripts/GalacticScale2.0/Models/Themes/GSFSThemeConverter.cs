...
namespace GalacticScale
{
    ...
    public class GSFSThemeConverter : fsDirectConverter<GSTheme>
    {
        ...
        protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref GSTheme model)
        {
            ...
            if (data.ContainsKey("terrainMaterial")) DeserializeMember(data, null, "terrainMaterial", out model.terrainMaterial);
            if (data.ContainsKey("terrainTint")) DeserializeMember(data, null, "terrainTint", out model.terrainTint);
            if (data.ContainsKey("oceanMaterial")) DeserializeMember(data, null, "oceanMaterial", out model.oceanMaterial);
            if (data.ContainsKey("oceanTint")) DeserializeMember(data, null, "oceanTint", out model.oceanTint);
            if (data.ContainsKey("atmosphereMaterial")) DeserializeMember(data, null, "atmosphereMaterial", out model.atmosphereMaterial);
            if (data.ContainsKey("atmosphereTint")) DeserializeMember(data, null, "atmosphereTint", out model.atmosphereTint);
            if (data.ContainsKey("thumbMaterial")) DeserializeMember(data, null, "thumbMaterial", out model.thumbMaterial);
            if (data.ContainsKey("thumbTint")) DeserializeMember(data, null, "thumbTint", out model.thumbTint);

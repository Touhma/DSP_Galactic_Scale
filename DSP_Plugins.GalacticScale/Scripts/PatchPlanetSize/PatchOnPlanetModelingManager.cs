...
namespace GalacticScale.Scripts.PatchPlanetSize
{
    ...
    public class PatchOnPlanetModelingManager : MonoBehaviour
    {
            ...
            ref MeshRenderer ___tmpPlanetReformRenderer)
        {
            ...
            else if (___currentModelingStage == 2)
            {
                ...
                for (var index1 = 0; index1 < 4; ++index1)
                {
                    ...
                    for (var index2 = 0; index2 < planetPrecision; index2 += planetPrecisionBySegment)
                        for (var index3 = 0; index3 < planetPrecision; index3 += planetPrecisionBySegment) // for each segment
            ...
            else if (___currentModelingStage == 3)
            {
                ___tmpPlanetBodyGameObject.SetActive(value: true);
                ___tmpPlanetReformGameObject.SetActive(value: true);
            ...
            else
            {
                ...
                if (planet.wanted)
                {
                    ...
                    PlanetSimulator component2 = ___tmpPlanetGameObject.GetComponent<PlanetSimulator>();
                    component2.surfaceRenderer = new Renderer[___tmpMeshRendererList.Count];
                    component2.surfaceCollider = new Collider[___tmpMeshColliderList.Count];
                    for (int num56 = 0; num56 < ___tmpMeshList.Count; num56++)
                    {
                        planet.meshes[num56] = ___tmpMeshList[num56];
                        planet.meshRenderers[num56] = ___tmpMeshRendererList[num56];
                        planet.meshColliders[num56] = ___tmpMeshColliderList[num56];
                    }
                    for (int num57 = 0; num57 < ___tmpMeshRendererList.Count; num57++)
                    {
                        ___tmpMeshRendererList[num57].gameObject.layer = 31;
                        ___tmpMeshRendererList[num57].sharedMaterial = planet.terrainMaterial;
                        ___tmpMeshRendererList[num57].receiveShadows = false;
                        ___tmpMeshRendererList[num57].shadowCastingMode = ShadowCastingMode.Off;
                        component2.surfaceRenderer[num57] = ___tmpMeshRendererList[num57];
                        component2.surfaceCollider[num57] = ___tmpMeshColliderList[num57];
                    }
                    component2.oceanCollider = ___tmpOceanCollider;
                    component2.sphereCollider = ___tmpPlanetBodyGameObject.AddComponent<SphereCollider>();
                    ...
                    component2.reformRenderer = ___tmpPlanetReformRenderer;
                ...
                {
                    for (int num58 = 0; num58 < ___tmpMeshList.Count; num58++)
                    {
                        Object.Destroy(___tmpMeshList[num58]);
                    }
                    Object.Destroy(___tmpPlanetGameObject);
                    ___tmpPlanetGameObject = null;
                    ___tmpPlanetBodyGameObject = null;
                    ___tmpPlanetReformGameObject = null;
                    ___tmpPlanetReformRenderer = null;

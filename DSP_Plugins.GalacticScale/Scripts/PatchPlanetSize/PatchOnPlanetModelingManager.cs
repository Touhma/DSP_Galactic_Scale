...
namespace GalacticScale.Scripts.PatchPlanetSize {
    ...
    public class PatchOnPlanetModelingManager : BaseUnityPlugin {
        [HarmonyPrefix]
        ...
        public static bool ModelingPlanetMain(PlanetData planet,
            ...
            if (planet.name == "Luna") {
                Patch.scaleFactor = (planet.radius / 200);
                ...
                Patch.Debug("Planet Scale :" + planet.scale, LogLevel.Debug,
                    Patch.DebugPlanetModelingManager);
                Patch.Debug("Planet scaleFactor :" + Patch.scaleFactor, LogLevel.Debug,
                    Patch.DebugPlanetModelingManager);

...
namespace GalacticScale.Scripts.PatchStarSystemGeneration
{
    ...
    public class PatchOnUniverseGen
    {
        ...
        public static bool CreateGalaxy(GameDesc gameDesc, ref GalaxyData __result, ref List<VectorLF3> ___tmp_poses)
        {
            ...
            settings.BirthStar = new star("BeetleJuice", ESpectrType.O, EStarType.MainSeqStar, p);
            for (var i = 0; i < 2; i++)
            {
                settings.Stars.Add(new star("Star" + i.ToString(), ESpectrType.X, EStarType.BlackHole, p));

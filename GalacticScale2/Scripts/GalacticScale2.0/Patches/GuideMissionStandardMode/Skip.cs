            ...
            ref GuideMissionStandardMode __instance)
        {
            ...
            if (_gameData == null)
                return GS2.AbortGameStart(
                    "An error occured during game creation, resulting in no game data being created");
            ...
            if (__instance.gameData.mainPlayer == null)
                return GS2.AbortGameStart(
                    "An error occured during game creation, resulting in no player character being created");
            ...
            if (__instance.player.controller == null)
                return GS2.AbortGameStart(
                    "Player controller failed to initialize. Probably an issue with galaxy generation.");
            ...
            __instance.targetUPos = __instance.localPlanet.uPosition +
                                    (VectorLF3) (__instance.localPlanet.runtimeRotation * __instance.targetPos);

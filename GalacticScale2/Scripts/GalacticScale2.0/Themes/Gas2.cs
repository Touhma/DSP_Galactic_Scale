        ...
        public static GSTheme Gas2 = new GSTheme
        {
            ...
            terrainMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_AmbientColor1"] = new Color(0.1607843f, 0.1254902f, 0.0627451f, 1f),
                    ["_AmbientColor2"] = new Color(0.172549f, 0.1372549f, 0.07450981f, 1f),
                    ["_Color"] = new Color(1f, 1f, 1f, 1f),
                    ["_EmissionColor"] = new Color(0f, 0f, 0f, 1f),
                    ["_FlowColor"] = new Color(0.735849f, 0.735849f, 0.735849f, 0.7843137f),
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new Color(0.764151f, 0.5872616f, 0.4433517f, 1f),
                    ["_Color1"] = new Color(0.7264151f, 0.5578381f, 0.2912513f, 1f),
                    ["_Color2"] = new Color(0.735849f, 0.566875f, 0.3228016f, 1f),
                    ["_Color3"] = new Color(0.7264151f, 0.619922f, 0.4214578f, 1f),
                    ["_Color4"] = new Color(1f, 0.7341459f, 0.4112499f, 1f),
                    ["_Color5"] = new Color(0f, 0f, 0f, 1f),
                    ["_Color6"] = new Color(0.08347761f, 0f, 0.2830189f, 1f),
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new Color(1f, 0.8933029f, 0.682353f, 1f),
                    ["_ColorBio0"] = new Color(1f, 0.8131745f, 0.6078432f, 1f),
                    ["_ColorBio1"] = new Color(0.8f, 0.5485438f, 0.2901962f, 1f),
                    ["_ColorBio2"] = new Color(1f, 0.8502486f, 0.627451f, 1f),
                    ["_EmissionColor"] = new Color(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new Color(-0.1f, 0.3f, 0.1f, 0.1f),
                    ["_RimColor"] = new Color(1f, 0.7934416f, 0.3921568f, 1f),
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new Color(1f, 0.8933029f, 0.682353f, 1f),
                    ["_ColorBio0"] = new Color(1f, 0.8131745f, 0.6078432f, 1f),
                    ["_ColorBio1"] = new Color(0.8f, 0.5485438f, 0.2901961f, 1f),
                    ["_ColorBio2"] = new Color(1f, 0.8502486f, 0.6274511f, 1f),
                    ["_EmissionColor"] = new Color(0f, 0f, 0f, 1f),

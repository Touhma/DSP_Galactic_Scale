...
namespace GalacticScale
{
    ...
    {
        public static void GenerateVeinsGS2R(GSPlanet gsPlanet, bool sketchOnly)
        {
        ...
        private static List<GSVeinDescriptor> DistributeVeinTypesGS2R(List<GSVeinType> veinGroups)
        {

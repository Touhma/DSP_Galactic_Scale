...
namespace GalacticScale
{
    public static class SystemDisplay
    {
        ...
        public static bool OnGalaxyDataReset(UIVirtualStarmap __instance)
        {
            //GS2.Error("............................................");
            ...
            OnGalaxyDataResetPostFix(__instance);
            return false;
        }
        public static void OnGalaxyDataResetPostFix(UIVirtualStarmap __instance)
        {
            foreach (var s in __instance.starPool)
            {
                ...
                var bc = gsStar.GetBinaryCompanion();
                if (bc != null && s.textContent != null) s.textContent += $" with {StripStarFromDisplayType( bc.displayType)} binary";
            }
        }

...
namespace GalacticScale
{
    ...
    public static partial class Utils
    {
        ...
        //     var num = 200f;
        //     GS2.Log(enemyData.astroId.ToString());
        ...
        //         num += diff;
        //     }
        //     if (VFInput.alt) GS2.Log($"GetRadiusFromFactory Called By {GS2.GetCaller(0)} {GS2.GetCaller(1)} {GS2.GetCaller(2)} orig:{orig} returning {num}");
        //     
        //     
        //     
        ...
        //     num += diff;
        //     if (negative) num *= -1;
        //     if (VFInput.alt) GS2.Log($"GetRadiusFromAstroId Called By {GS2.GetCaller(0)} {GS2.GetCaller(1)} {GS2.GetCaller(2)} returning {num}");
        //     return (T)Convert.ChangeType(num, typeof(T));
        // }
        // public static T GetRadiusFromLocalPlanet<T>(T t)
        // {

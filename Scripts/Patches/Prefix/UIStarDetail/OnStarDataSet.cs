...
namespace GalacticScale.Patches
{
    public partial class PatchOnUIStarDetail
    {
        ...
        private static bool OnStarDataSet(StarData ____star, InputField ___nameInput, Text ___typeText,
            RectTransform ___paramGroup, Text ___massValueText, Text ___spectrValueText, Text ___radiusValueText,
            Text ___luminoValueText, Text ___temperatureValueText, Text ___ageValueText, Sprite ___unknownResIcon,
            GameObject ___trslBg, GameObject ___imgBg, UIResAmountEntry ___tipEntry, UIResAmountEntry ___entryPrafab,
        ...
        [HarmonyPrefix, HarmonyPatch(typeof(UIStarDetail), nameof(UIStarDetail.OnStarDataSet))]
        public static bool OnStarDataSet2(StarData ____star, InputField ___nameInput, Text ___typeText,
            RectTransform ___paramGroup, Text ___massValueText, Text ___spectrValueText, Text ___radiusValueText,
            Text ___luminoValueText, Text ___temperatureValueText, Text ___ageValueText, Sprite ___unknownResIcon,
            GameObject ___trslBg, GameObject ___imgBg, UIResAmountEntry ___tipEntry, UIResAmountEntry ___entryPrafab,
            ref UIStarDetail __instance)
        {
            ...
            if (__instance.star != null)
            {
                ...
                {
                    __instance.star.CalcVeinAmounts(ref __instance.veinAmounts, __instance.tmp_ids,
                        __instance.uiGame.veinAmountDisplayFilter);
                    __instance.star.CalcVeinCounts(ref __instance.veinCounts, __instance.tmp_ids,
                        __instance.uiGame.veinAmountDisplayFilter);
                }
                ...
                {
                    __instance.ageValueText.text = (__instance.star.age * __instance.star.lifetime).ToString("#,##0 ") +
                                                   "百万亿年".Translate();
                }
                else
                {
                    __instance.ageValueText.text =
                        (__instance.star.age * __instance.star.lifetime * 0.01f).ToString("#,##0.00 ") +
                        "百万亿年".Translate();
                }
                    ...
                    for (int j = 1; j < 15; j++)
                    {
                        ...
                        if (flag2 || j < 7)
                        {
                            ...
                            if (veinProto != null && itemProto != null && flag3)
                            {
                                ...
                                entry.SetInfo(index, itemProto.name, veinProto.iconSprite, veinProto.description,
                                    j >= 7, false, (j == 7) ? "         /s" : "                ");
                                entry.refId = num4;
                                index++;
                        ...
                        if (waterItemId > 0)
                        {
                            ...
                            if (itemProto2 != null)
                            {
                                ...
                                if (__instance.uiGame.veinAmountDisplayFilter == 0)
                                {
                                    ...
                                    entry2.SetInfo(index, text, iconSprite, itemProto2.description,
                                        itemProto2 != null && waterItemId != 1000, false, "");
                                ...
                                else if (__instance.uiGame.veinAmountDisplayFilter == 1)
                                {
                                    ...
                                    if (factory != null)
                                    {
                                        ...
                                        for (int l = 0; l < minerCursor; l++)
                                        {
                                            ...
                                            if (ptr.id == l && ptr.type == EMinerType.Water &&
                                                consumerPool[ptr.pcId].networkId > 0)
                                            {
                                    ...
                                    if (num5 > 0f)
                                    {
                                        ...
                                        entry3.SetInfo(index, text ?? "", iconSprite, itemProto2.description,
                                            waterItemId != 1000, false, "");
                                        entry3.valueString = (num5 * GameMain.history.miningSpeedScale).ToString("0") +
                                                             " /min";
                                        index++;
                                        flag = true;
                                    }
                                ...
                                if (itemProto3 != null)
                                {
                                    if (flag2)
                                    {
                                        if (__instance.uiGame.veinAmountDisplayFilter == 0)
                                        {
                                            ...
                                            entry4.SetInfo(index, itemProto3.name, itemProto3.iconSprite,
                                                itemProto3.description, false, false, "        /s");
                                            StringBuilderUtility.WritePositiveFloat(entry4.sb, 0, 7,
                                                planetData.gasSpeeds[n], 2, ' ');
                                        ...
                                        else if (__instance.uiGame.veinAmountDisplayFilter == 1)
                                        {
                                            ...
                                            if (factory2 != null)
                                            {
                                                ...
                                                for (int num10 = 1; num10 < stationCursor; num10++)
                                                {
                                                    ...
                                                    if (stationComponent != null && stationComponent.id == num10 &&
                                                        stationComponent.isCollector)
                                                    {
                                                        for (int num11 = 0;
                                                             num11 < stationComponent.storage.Length;
                                                             num11++)
                                                        {
                                                            if (stationComponent.storage[num11].itemId ==
                                                                planetData.gasItems[n] &&
                                                                stationComponent.storage[num11].remoteLogic ==
                                                                ELogisticStorage.Supply)
                                                            {
                                                                PrefabDesc prefabDesc = LDB.items
                                                                    .Select(ItemProto.stationCollectorId).prefabDesc;
                                                                double num12 = (double)prefabDesc.workEnergyPerTick *
                                                                    60.0 / (double)prefabDesc.stationCollectSpeed;
                                                                double num13 = (double)miningSpeedScale2;
                                                                double num14 = num12;
                                                                double gasTotalHeat = planetData.gasTotalHeat;
                                                                double num15 = (double)((gasTotalHeat - num14 <= 0.0)
                                                                    ? 1f
                                                                    : ((float)((num13 * gasTotalHeat - num14) /
                                                                               (gasTotalHeat - num14))));
                                                                double num16 =
                                                                    (double)stationComponent.collectionPerTick[num11] *
                                                                    num15;
                                            ...
                                            if (num9 > 0.0)
                                            {
                                                ...
                                                entry5.SetInfo(index, itemProto3.name, itemProto3.iconSprite,
                                                    itemProto3.description, false, false, "");
                                                if (num9 < 10000.0)
                                                {
                                                ...
                                                {
                                                    entry5.valueString = string.Format("{0:0.000}M /min",
                                                        num9 / 1000000.0);
                                                }
                                        ...
                                        else if (__instance.uiGame.veinAmountDisplayFilter == 2)
                                        {
                                            ...
                                            if (factory3 != null)
                                            {
                                                ...
                                                for (int num18 = 1; num18 < stationCursor2; num18++)
                                                {
                                                    ...
                                                    if (stationComponent2 != null && stationComponent2.id == num18 &&
                                                        stationComponent2.isCollector)
                                                    {
                                                        for (int num19 = 0;
                                                             num19 < stationComponent2.storage.Length;
                                                             num19++)
                                                        {
                                                            if (stationComponent2.storage[num19].itemId ==
                                                                planetData.gasItems[n] &&
                                                                stationComponent2.storage[num19].remoteLogic ==
                                                                ELogisticStorage.Supply)
                                                            {
                                                                flag4 = true;
                                                                break;
                                            ...
                                            if (!flag4)
                                            {
                                                ...
                                                entry6.SetInfo(index, "可采集".Translate() + itemProto3.name,
                                                    itemProto3.iconSprite, "环绕行星手动采集".Translate(), false, false,
                                                    "        /s");
                                                StringBuilderUtility.WritePositiveFloat(entry6.sb, 0, 7,
                                                    planetData.gasSpeeds[n], 4, ' ');
                                    ...
                                    else if (__instance.uiGame.veinAmountDisplayFilter != 1)
                                    {
                                        ...
                                        entry7.SetInfo(index, "未知".Translate(), __instance.unknownResIcon, "", false,
                                            false, "        /s");
                                    ...
                                    else
                                    {
                                        ...
                                        if (factory4 != null)
                                        {
                                            ...
                                            for (int num20 = 1; num20 < stationCursor3; num20++)
                                            {
                                                ...
                                                if (stationComponent3 != null && stationComponent3.id == num20 &&
                                                    stationComponent3.isCollector)
                                                {
                                                    for (int num21 = 0;
                                                         num21 < stationComponent3.storage.Length;
                                                         num21++)
                                                    {
                                                        if (stationComponent3.storage[num21].itemId ==
                                                            planetData.gasItems[n] &&
                                                            stationComponent3.storage[num21].remoteLogic ==
                                                            ELogisticStorage.Supply)
                                                        {
                                                            flag5 = true;
                                                            break;
                                        ...
                                        if (flag5)
                                        {
                                            ...
                                            entry8.SetInfo(index, "未知".Translate(), __instance.unknownResIcon, "",
                                                false, false, "        /s");
                ...
                if (____star.initialHiveCount > 0)
                {
                    UIResAmountEntry entry = __instance.GetEntry();
                    __instance.entries.Add(entry);
                    entry.SetInfo(index, "DarkFog Infested".Translate(), __instance.unknownResIcon, "", false, false,
                        "        /s");

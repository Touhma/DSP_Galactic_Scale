...
namespace GalacticScale.Patches
{
    ...
    {
        /*
         * these can get nulled for whatever reason when in a multiplayer session and being the client.
         * resetting them solves the issue.
         */
        [HarmonyPrefix]
        [HarmonyPatch(typeof(PlayerFootsteps), nameof(PlayerFootsteps.PlayFootstepSound))]

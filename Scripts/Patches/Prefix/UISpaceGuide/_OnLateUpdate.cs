...
namespace GalacticScale.Patches
{
    public partial class PatchOnUISpaceGuide
    {
        ...
        [HarmonyPrefix]
        [HarmonyPatch(typeof(UISpaceGuide), nameof(UISpaceGuide._OnLateUpdate))]
        public static bool _OnLateUpdate(ref UISpaceGuide __instance)
        {
            ...
            if (!VFInput.inFullscreenGUI && flag)
            {
                ...
                if (__instance.gameData.localStar != null)
                {
                    ...
                    {
                        //GS3.Warn((index2).ToString() + " " + __instance.astroPoses[index2].uRadius.ToString() + " " + GameMain.galaxy.PlanetById(index2).name);

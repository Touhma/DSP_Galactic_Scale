...
namespace GalacticScale.Patches
{
	public partial class PatchOnUIPlanetDetail
	{
		...
		{
			// GS3.Warn("Dataset");
			// GS3.Warn(__instance.obliquityValueText.transform.parent.transform.parent.childCount.ToString());
			// Add the planets radius to the Planet Detail UI
			// if (GS3.GetGSPlanet( __instance.planet).GsTheme.DisplayName == "Comet") __instance.

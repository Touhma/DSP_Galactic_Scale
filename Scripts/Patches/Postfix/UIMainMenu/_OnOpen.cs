...
namespace GalacticScale.Patches
{
    public static class PatchOnUIMainMenu
    {
        ...
        [HarmonyPostfix,HarmonyPatch(typeof(UIMainMenu), nameof(UIMainMenu._OnOpen))]
        public static void _OnOpen(ref UIMainMenu __instance)
        {
            ...
            GS3.Log("Attempting to get exit button");
            ...
            buttonRectTransform.GetComponentInChildren<Text>().text = "GS3 Help";

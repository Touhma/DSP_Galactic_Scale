...
namespace GalacticScale
{
    ...
    {
        public static GSTheme IceGiant4 = new()
        {
            Name = "IceGiant4",
            Base = true,
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.2318469f, 0.1411764f, 0.7254902f, 1f),
                    ["_Color1"] = new(0.4940115f, 0.4269758f, 0.8962264f, 1f),
                    ["_Color2"] = new(0.5144389f, 0.4978195f, 0.9339623f, 1f),
                    ["_Color3"] = new(0.8055844f, 0.7028302f, 1f, 1f),
                    ["_Color4"] = new(1f, 0.748152f, 0.4162875f, 1f),
                    ["_Color5"] = new(0f, 0f, 0f, 1f),
                    ["_Color6"] = new(0.1512139f, 0f, 0.490196f, 1f),
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.6771148f, 0.5333334f, 1f, 1f),
                    ["_ColorBio0"] = new(0.8519266f, 0.6941177f, 1f, 1f),
                    ...
                    ["_RimColor"] = new(0.6376486f, 0.4392157f, 1f, 1f),
            ...
            terrainMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_DistortSettings1"] = new(100f, 27f, 10f, 13f),
                    ["_DistortSettings2"] = new(22f, 11f, 10f, 19f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_FlowColor"] = new(0.7830188f, 0.7830188f, 0.7830188f, 0.8862745f),
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new(0.634164f, 0.4386792f, 1f, 1f),
                    ["_ColorBio0"] = new(0.8729784f, 0.8160377f, 1f, 1f),
                    ...
                    ["_RimColor"] = new(0.6453348f, 0.4009434f, 1f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_ShoreLineColor"] = new(0f, 0f, 0f, 0f),

...
namespace GalacticScale
{
    ...
    {
        public static GSTheme Gas5 = new()
        {
            Name = "GasGiant5",
            Base = true,
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.1411764f, 0.4477702f, 0.7254902f, 1f),
                    ["_Color1"] = new(0.3073465f, 0.5369307f, 0.748f, 1f),
                    ["_Color2"] = new(0.3186684f, 0.5413523f, 0.741f, 1f),
                    ["_Color3"] = new(0.4075738f, 0.5426658f, 0.6698113f, 1f),
                    ["_Color4"] = new(1f, 0.7494254f, 0.4167455f, 1f),
                    ["_Color5"] = new(0f, 0f, 0f, 1f),
                    ["_Color6"] = new(0f, 0.3624897f, 0.490196f, 1f),
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.2117647f, 0.649365f, 1f, 1f),
                    ["_ColorBio0"] = new(0.627451f, 0.86207f, 1f, 1f),
                    ["_ColorBio1"] = new(0.2901962f, 0.5231699f, 0.8f, 1f),
                    ["_ColorBio2"] = new(0.627451f, 0.7820068f, 1f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new(-0.1f, 0.3f, 0.1f, 0.1f),
                    ["_RimColor"] = new(0.4392157f, 0.71207f, 1f, 1f),
            ...
            terrainMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_DistortSettings1"] = new(80f, 27f, 7f, 13f),
                    ["_DistortSettings2"] = new(15f, 13f, 7f, 19f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new(0.2793699f, 0.708092f, 0.8113208f, 1f),
                    ["_ColorBio0"] = new(0.5255874f, 0.7977122f, 0.8773585f, 1f),
                    ["_ColorBio1"] = new(0.2901962f, 0.5709947f, 0.8f, 1f),
                    ...
                    ["_RimColor"] = new(0.2117647f, 0.7437117f, 1f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_ShoreLineColor"] = new(0f, 0f, 0f, 0f),
                    ["_SpecularColor"] = new(0.5188679f, 0.3004048f, 0.1737718f, 1f),
                    ["_Spot0"] = new(0.6f, -0.3f, -0.5f, 1f),

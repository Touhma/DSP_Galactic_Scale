...
namespace GalacticScale
{
    public static partial class Themes
    {
        ...
        public static GSTheme OceanWorld = new()
        {
            Name = "OceanWorld",
            Base = true,
            ...
            terrainMaterial = new GSMaterialSettings
            {
                ...
                {
                    ["_AmbientColor0"] = new(0.1098038f, 0.1415093f, 0.1333332f, 1f),
                    ["_AmbientColor1"] = new(0.06666655f, 0.03519787f, 0.03137255f, 1f),
                    ["_AmbientColor2"] = new(0.03921569f, 0.03921569f, 0.1764704f, 1f),
                    ...
                    ["_SunDir"] = new(0.3786571f, 0.01833941f, 0.9253553f, 0f)
                },
            ...
            oceanMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_CausticsColor"] = new(0.5506853f, 0.7075471f, 0.6751246f, 1f),
                    ["_Color"] = new(1f, 0.9647059f, 0.7686275f, 1f),
                    ["_Color0"] = new(0f, 0.1574037f, 0.2352941f, 1f),
                    ["_Color1"] = new(0.5764706f, 0.8313726f, 0.7921569f, 1f),
                    ["_Color2"] = new(0.3551085f, 0.6892567f, 0.7169812f, 1f),
                    ["_Color3"] = new(0.2731398f, 0.504477f, 0.5849056f, 1f),
                    ["_DensityParams"] = new(0.02f, 0.1f, 0f, 0f),
                    ["_DepthColor"] = new(0f, 0.06095791f, 0.1132075f, 1f),
                    ["_DepthFactor"] = new(0.4f, 0.35f, 0.15f, 0.1f),
                    ["_Foam"] = new(15f, 1f, 5f, 1.5f),
                    ["_FoamColor"] = new(1f, 1f, 1f, 1f),
                    ["_FoamParams"] = new(12f, 0.2f, 0.15f, 0.7f),
                    ["_FresnelColor"] = new(0.2470588f, 0.6588235f, 0.8862746f, 1f),
                    ...
                    ["_SpeclColor1"] = new(0.8962264f, 0.614061f, 0.1733267f, 1f),
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.3882353f, 0.7017767f, 1f, 1f),
                    ["_Color1"] = new(0.28854f, 0.7906604f, 0.916f, 1f),
                    ["_Color2"] = new(0.4466639f, 0.84536f, 0.888f, 1f),
                    ["_Color3"] = new(0.7357877f, 0.923f, 0.9083642f, 1f),
                    ["_Color4"] = new(1f, 0.7438396f, 0.4147364f, 1f),
                    ["_Color5"] = new(0.2392156f, 0.8758385f, 1f, 1f),
                    ["_Color6"] = new(0.3529411f, 0.7509555f, 1f, 1f),
                    ["_Color7"] = new(0.2078431f, 0.4966022f, 0.6980392f, 1f),
                    ["_Color8"] = new(1f, 1f, 1f, 1f),
                    ["_ColorF"] = new(0.4669811f, 0.9485019f, 1f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_LocalPos"] = new(78.1805f, 142.5101f, 140.7908f, 0f),
                    ["_PlanetPos"] = new(0f, 0f, 0f, 0f),
                    ["_PlanetRadius"] = new(200f, 199.98f, 270f, 0f),
                    ["_Sky0"] = new(0.4198112f, 0.6650285f, 1f, 0.1607843f),
                    ["_Sky1"] = new(0.485849f, 0.5557498f, 1f, 0.09803922f),
                    ["_Sky2"] = new(0.839f, 1f, 0.9984235f, 0.9176471f),
                    ["_Sky3"] = new(0.2666666f, 0.7909663f, 1f, 0.6705883f),
                    ["_Sky4"] = new(1f, 0.7368349f, 0.3171324f, 1f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_AtmoDensity"] = 1f,
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.3632075f, 0.7256894f, 1f, 1f),
                    ["_ColorBio0"] = new(0f, 0f, 0f, 0f),
                    ["_ColorBio1"] = new(0f, 0f, 0f, 0f),
                    ["_ColorBio2"] = new(0f, 0f, 0f, 0f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new(-1f, 0f, 0.1f, 0.3f),
                    ["_RimColor"] = new(0.7001489f, 1f, 0.5330188f, 1f),
                    ["_ShoreLineColor"] = new(0.2672659f, 0.3639862f, 0.3962263f, 1f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 0f,
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.3176471f, 0.9740799f, 1f, 1f),
                    ["_ColorBio0"] = new(0f, 0f, 0f, 0f),
                    ["_ColorBio1"] = new(0f, 0f, 0f, 0f),
                    ["_ColorBio2"] = new(0f, 0f, 0f, 0f),
                    ["_HeightSettings"] = new(-1f, 0f, 0.1f, 0.3f),
                    ["_RimColor"] = new(0.7001489f, 1f, 0.5330188f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_ShoreLineColor"] = new(0.2672658f, 0.3639862f, 0.3962263f, 1f),

...
namespace GalacticScale
{
    ...
    {
        public static GSTheme FrozenTundra = new GSTheme
        {
            Name = "FrozenTundra",
            Base = true,
...
["_Color0"] = new Color(0.4509804f, 0.6627451f, 0.6705883f,1f),
["_Color1"] = new Color(0.5254902f, 0.7176471f, 0.8196079f,1f),
["_Color2"] = new Color(0.5254902f, 0.7176471f, 0.8196079f,1f),
["_Color3"] = new Color(0.5647059f, 0.7450981f, 0.9058824f,1f),
["_Color4"] = new Color(1f, 0.7520539f, 0.4176908f,1f),
["_Color5"] = new Color(0.1161444f, 0.2988604f, 0.5471698f,1f),
["_Color6"] = new Color(0.207854f, 0f, 0.6980392f,1f),
["_Color7"] = new Color(0.04705869f, 0.1607841f, 0.6039216f,1f),
["_Color8"] = new Color(1f, 1f, 1f,1f),
["_ColorF"] = new Color(0.572549f, 0.7529412f, 0.723219f,1f),
["_EmissionColor"] = new Color(0f, 0f, 0f,1f),
["_LocalPos"] = new Color(-133.766f, 145.778f, 40.82097f,0f),
["_PlanetPos"] = new Color(0f, 0f, 0f,0f),
["_PlanetRadius"] = new Color(200f, 100f, 260f,0f),
["_Sky0"] = new Color(0f, 0.5333136f, 0.6320754f,0.3921569f),
["_Sky1"] = new Color(0.001868997f, 0.3291016f, 0.3962263f,0.2588235f),
["_Sky2"] = new Color(0.4285332f, 0.7334126f, 0.8490566f,0.7490196f),
["_Sky3"] = new Color(0.03921569f, 0.2235293f, 0.3411763f,0.5254902f),
["_Sky4"] = new Color(1f, 0.7491269f, 0.3329717f,1f),
},
...
{
Colors = new Dictionary<string, Color>{
["_Color"] = new Color(0.1541918f, 0.1608487f, 0.1981131f,1f),
["_ColorBio0"] = new Color(0.03671236f, 0.1322978f, 0.2358489f,1f),
["_ColorBio1"] = new Color(0.2353595f, 0.3262192f, 0.3867924f,1f),
["_ColorBio2"] = new Color(0.8f, 0.8f, 0.8f,1f),
["_EmissionColor"] = new Color(0f, 0f, 0f,1f),
["_HeightSettings"] = new Color(-0.1f, 0.3f, 0.1f,0.1f),
["_RimColor"] = new Color(0.4342292f, 0.6761103f, 0.7735849f,1f),
...
{
Colors = new Dictionary<string, Color>{
["_AmbientColor0"] = new Color(0.03399784f, 0.03458045f, 0.03773582f,1f),
["_AmbientColor1"] = new Color(0.05237616f, 0.06265562f, 0.1037734f,1f),
["_AmbientColor2"] = new Color(0.1243323f, 0.1385397f, 0.207547f,1f),
["_Color"] = new Color(1f, 1f, 1f,1f),
["_EmissionColor"] = new Color(0f, 0f, 0f,1f),
["_GICloudColor"] = new Color(1f, 1f, 1f,1f),
["_HeightEmissionColor"] = new Color(0f, 0f, 0f,0f),
["_LightColorScreen"] = new Color(0.7783019f, 0.907494f, 1f,1f),
["_Rotation"] = new Color(0f, 0f, 0f,1f),
["_SpeclColor"] = new Color(1f, 1f, 1f,1f),
["_SunDir"] = new Color(0.1715005f, -0.07155281f, -0.9825822f,0f),
},
Params = new Dictionary<string, float>{
["_AmbientInc"] = -0.5f,
["_BioFuzzMask"] = 1f,
...
["_Color"] = new Color(0.1975792f, 0.2087932f, 0.2264151f,1f),
["_ColorBio0"] = new Color(0.02069241f, 0.08110091f, 0.1415094f,1f),
["_ColorBio1"] = new Color(0.2352941f, 0.3254902f, 0.3882353f,1f),
["_ColorBio2"] = new Color(0.982906f, 0.9957265f, 1f,1f),
["_EmissionColor"] = new Color(0f, 0f, 0f,1f),
...
["_RimColor"] = new Color(0f, 0.7081624f, 0.8962264f,1f),
["_Rotation"] = new Color(-0.005426358f, 0.9974841f, -0.04323564f,0.05591735f),
["_ShoreLineColor"] = new Color(0f, 0f, 0f,0f),
["_SpecularColor"] = new Color(0.5188679f, 0.3004048f, 0.1737718f,1f),
["_Spot0"] = new Color(0.6f, -0.3f, -0.5f,1f),
["_SunDir"] = new Color(0.9997593f, 0.003957998f, 0.02157881f,0f),
},
Params = new Dictionary<string, float>{
["_BioStrength"] = 0.8f,

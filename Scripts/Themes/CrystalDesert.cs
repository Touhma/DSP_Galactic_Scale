...
namespace GalacticScale
{
    ...
    {
        public static GSTheme CrystalDesert = new()
        {
            Name = "CrystalDesert",
            Base = true,
...
//AmbientSettings 1
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0f, 0.5480272f, 0.6698113f, 1f),
                    ["_Color1"] = new(0.3019607f, 0.5607843f, 0.6705883f, 1f),
                    ["_Color2"] = new(0.357022f, 0.5783352f, 0.6698113f, 1f),
                    ["_Color3"] = new(0.608179f, 0.7073157f, 0.745283f, 1f),
                    ["_Color4"] = new(1f, 0.7482267f, 0.4163144f, 1f),
                    ["_Color5"] = new(0.3224253f, 0.2627448f, 0.8862745f, 1f),
                    ["_Color6"] = new(0.2146669f, 0.6243376f, 0.6792453f, 1f),
                    ["_Color7"] = new(0.202919f, 0.375155f, 0.4528299f, 1f),
                    ["_Color8"] = new(0.5355552f, 0.7375664f, 0.7830188f, 1f),
                    ["_ColorF"] = new(0.517444f, 0.6661898f, 0.7169812f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_LocalPos"] = new(135.9492f, 55.65244f, -136.3778f, 0f),
                    ["_PlanetPos"] = new(0f, 0f, 0f, 0f),
                    ["_PlanetRadius"] = new(200f, 100f, 260f, 0f),
                    ["_Sky0"] = new(0.1827606f, 0.3324268f, 0.3490564f, 0.3215686f),
                    ["_Sky1"] = new(0.1830721f, 0.2725294f, 0.3207545f, 0.1686275f),
                    ["_Sky2"] = new(0.6775098f, 0.8084766f, 0.8207547f, 0.4f),
                    ["_Sky3"] = new(0f, 0.2429768f, 0.3584904f, 1f),
                    ["_Sky4"] = new(1f, 0.7433999f, 0.3255919f, 1f)
                },
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.2211641f, 0.4795249f, 0.6603774f, 1f),
                    ["_ColorBio0"] = new(0.839f, 0.5464357f, 0.217301f, 1f),
                    ["_ColorBio1"] = new(0.168469f, 0.2388467f, 0.287f, 1f),
                    ["_ColorBio2"] = new(0.195888f, 0.4744096f, 0.636f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new(-0.1f, 0.3f, 0.1f, 0.1f),
                    ["_RimColor"] = new(0f, 0.3997594f, 0.5647059f, 1f),
            ...
            terrainMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_AmbientColor0"] = new(0.09774543f, 0.1058909f, 0.112f, 1f),
                    ["_AmbientColor1"] = new(0.121527f, 0.1426123f, 0.189f, 1f),
                    ["_AmbientColor2"] = new(0.08354498f, 0.1124602f, 0.217f, 1f),
                    ["_Color"] = new(0.7048772f, 0.8673259f, 0.9056604f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_GICloudColor"] = new(1f, 1f, 1f, 1f),
                    ["_HeightEmissionColor"] = new(0f, 0f, 0f, 0f),
                    ["_LightColorScreen"] = new(1f, 0.7259278f, 0.4858491f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_SpeclColor"] = new(1f, 0.8249525f, 0f, 0.6784314f),
                    ["_SunDir"] = new(-0.9803334f, 0.08005269f, 0.1803827f, 0f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_AmbientInc"] = 0.5f,
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new(0.09207059f, 0.2202352f, 0.3372549f, 1f),
                    ["_ColorBio0"] = new(0.867f, 0.5452422f, 0.18207f, 1f),
                    ["_ColorBio1"] = new(0.043904f, 0.2511972f, 0.392f, 1f),
                    ["_ColorBio2"] = new(0.144396f, 0.390213f, 0.573f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ...
                    ["_RimColor"] = new(0.4386792f, 0.7010356f, 1f, 1f),
                    ["_Rotation"] = new(-0.2043909f, 0.07387411f, 0.09414349f, -0.9715472f),
                    ["_ShoreLineColor"] = new(0f, 0f, 0f, 0f),
                    ["_SpecularColor"] = new(0.5188679f, 0.3004048f, 0.1737718f, 1f),
                    ["_Spot0"] = new(0.6f, -0.3f, -0.5f, 1f),
                    ["_SunDir"] = new(-0.380532f, 0.05802305f, 0.9229457f, 0f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 0.8f,

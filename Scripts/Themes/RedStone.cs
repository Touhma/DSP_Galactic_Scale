...
namespace GalacticScale
{
    ...
    {
        public static GSTheme RedStone = new()
        {
            Name = "RedStone",
            Base = true,
            ...
            terrainMaterial = new GSMaterialSettings
            {
                ...
                {
                    ["_AmbientColor0"] = new(0.1333332f, 0.06533324f, 0.09157962f, 1f),
                    ["_AmbientColor1"] = new(0.1320753f, 0.09728687f, 0.03177287f, 1f),
                    ["_AmbientColor2"] = new(0.05142856f, 0.03214287f, 0.09f, 1f),
                    ["_Color"] = new(1f, 1f, 1f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightEmissionColor"] = new(0f, 0f, 0f, 0f),
                    ["_LightColorScreen"] = new(0.8396226f, 0.4079297f, 0.7331161f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_SunDir"] = new(-0.9664816f, -0.2524303f, -0.04682636f, 0f)
                },
            ...
            oceanMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_CausticsColor"] = new(1f, 0.8940002f, 0.485849f, 1f),
                    ["_Color"] = new(1f, 0.6839622f, 0.7887316f, 1f),
                    ["_Color0"] = new(0f, 0.1574037f, 0.2352941f, 1f),
                    ["_Color1"] = new(0.420624f, 0.7619999f, 0.7586573f, 1f),
                    ["_Color2"] = new(0f, 0.5289927f, 0.643f, 1f),
                    ["_Color3"] = new(0.2309999f, 0.6222066f, 0.7333333f, 1f),
                    ["_DensityParams"] = new(0.02f, 0.1f, 0f, 0f),
                    ["_DepthColor"] = new(0f, 0.06095791f, 0.1132075f, 1f),
                    ["_DepthFactor"] = new(0.4f, 1.2f, 0.35f, 0.1f),
                    ["_Foam"] = new(15f, 1f, 5f, 1.5f),
                    ["_FoamColor"] = new(1f, 1f, 1f, 1f),
                    ["_FoamParams"] = new(12f, 0.2f, 0.15f, 0.7f),
                    ["_FresnelColor"] = new(0.7620355f, 0.6839622f, 1f, 1f),
                    ...
                    ["_SpeclColor"] = new(0.8584906f, 0.8584906f, 0.8584906f, 1f),
                    ["_SpeclColor1"] = new(1f, 0.6678602f, 0.572549f, 1f),
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.2660198f, 0.3085042f, 0.9245283f, 1f),
                    ["_Color1"] = new(0.4280078f, 0.6013333f, 0.902f, 1f),
                    ["_Color2"] = new(0.4421568f, 0.6579294f, 0.902f, 1f),
                    ["_Color3"] = new(0.7678006f, 0.7216981f, 1f, 1f),
                    ["_Color4"] = new(1f, 0.5910653f, 0.3921568f, 1f),
                    ["_Color5"] = new(0.2405658f, 0.5836905f, 1f, 1f),
                    ["_Color6"] = new(0.3985406f, 0.3101636f, 0.7735849f, 1f),
                    ["_Color7"] = new(0.1128068f, 0.2254752f, 0.6132076f, 1f),
                    ["_Color8"] = new(1f, 1f, 1f, 1f),
                    ["_ColorF"] = new(0.7490196f, 0.6022118f, 0.6022118f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_LocalPos"] = new(-61.91296f, 50.18437f, 183.6744f, 0f),
                    ["_PlanetPos"] = new(0f, 0f, 0f, 0f),
                    ["_PlanetRadius"] = new(200f, 199.98f, 270f, 0f),
                    ["_Sky0"] = new(0.7221571f, 0.572549f, 1f, 0.1607843f),
                    ["_Sky1"] = new(0.5206776f, 0.4862745f, 1f, 0.09803922f),
                    ["_Sky2"] = new(1f, 0.7803922f, 0.9201165f, 0.7490196f),
                    ["_Sky3"] = new(0.3450977f, 0.7052943f, 1f, 0.5411765f),
                    ["_Sky4"] = new(1f, 0.6463005f, 0.1979999f, 1f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_AtmoDensity"] = 1.2f,
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.9254902f, 0.5182047f, 0.5098039f, 1f),
                    ["_ColorBio0"] = new(0f, 0f, 0f, 1f),
                    ["_ColorBio1"] = new(0f, 0f, 0f, 1f),
                    ["_ColorBio2"] = new(0f, 0f, 0f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new(-1f, 0f, 0.1f, 0.3f),
                    ["_RimColor"] = new(1f, 0.657f, 0.9876023f, 1f),
                    ["_ShoreLineColor"] = new(1f, 0.500879f, 0.259434f, 0f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 0f,
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new(0.916f, 0.5586367f, 0.5504215f, 1f),
                    ["_ColorBio0"] = new(0f, 0f, 0f, 0f),
                    ["_ColorBio1"] = new(0f, 0f, 0f, 1f),
                    ["_ColorBio2"] = new(0f, 0f, 0f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ...
                    ["_RimColor"] = new(1f, 0.6084906f, 0.7648496f, 1f),
                    ["_Rotation"] = new(0.1348138f, -0.9674751f, 0.07657813f, -0.1998829f),
                    ["_ShoreLineColor"] = new(0.6784314f, 0.4612247f, 0.1662157f, 1f),
                    ["_SpecularColor"] = new(0.5188679f, 0.3004048f, 0.1737718f, 1f),
                    ["_Spot0"] = new(0.6f, -0.3f, -0.5f, 1f),
                    ["_SunDir"] = new(0.9062576f, 0.07863805f, 0.4153472f, 0f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 0f,

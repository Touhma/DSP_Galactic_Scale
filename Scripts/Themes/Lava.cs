    ...
    public static partial class Themes
    {
        public static GSTheme Lava = new()
        {
            ...
            terrainMaterial = new GSMaterialSettings
            {
                ...
                {
                    ["_AmbientColor0"] = new(0.1490196f, 0.0967137f, 0.0967137f, 1f),
                    ["_AmbientColor1"] = new(0.09411757f, 0.02745098f, 0.02745098f, 1f),
                    ["_AmbientColor2"] = new(0.2470588f, 0.1716928f, 0.1675059f, 1f),
                    ["_Color"] = new(1f, 1f, 1f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightEmissionColor"] = new(1f, 0.4318202f, 0.08962256f, 0f),
                    ["_LightColorScreen"] = new(0f, 0f, 0f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_SunDir"] = new(-0.09377031f, -0.1095983f, -0.989543f, 0f)
                },
            ...
            oceanMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_CausticsColor"] = new(0.7830188f, 0.4789426f, 0.1514328f, 1f),
                    ["_Color"] = new(0.5283019f, 0.06240926f, 0.02741189f, 1f),
                    ["_Color0"] = new(1f, 0.6005338f, 0.2039215f, 1f),
                    ["_Color1"] = new(0.5943396f, 0.1462626f, 0.05887323f, 1f),
                    ["_Color2"] = new(0.2169811f, 0.04338999f, 0.01944642f, 1f),
                    ["_Color3"] = new(0.608f, 0.2877792f, 0.102144f, 1f),
                    ["_DensityParams"] = new(0.02f, 0.1f, 0f, 0f),
                    ["_DepthColor"] = new(0f, 0.06095791f, 0.1132075f, 1f),
                    ["_DepthFactor"] = new(0.57f, 0.8f, 0.4f, 0.04f),
                    ["_Foam"] = new(15f, 1f, 5f, 1.5f),
                    ["_FoamColor"] = new(1f, 0.4062188f, 0.2311321f, 1f),
                    ["_FoamParams"] = new(12f, 0.2f, 0.15f, 0.7f),
                    ["_FresnelColor"] = new(1f, 0.5575014f, 0f, 1f),
                    ...
                    ["_SpeclColor"] = new(1f, 0f, 0f, 1f),
                    ["_SpeclColor1"] = new(1f, 0.7611813f, 0f, 1f),
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.517647f, 0.3568627f, 0.4803259f, 1f),
                    ["_Color1"] = new(0.6980392f, 0.4488391f, 0.5287111f, 1f),
                    ["_Color2"] = new(0.8235294f, 0.4694117f, 0.5056283f, 1f),
                    ["_Color3"] = new(1f, 0.5202159f, 0.43f, 1f),
                    ["_Color4"] = new(1f, 0.7571103f, 0.4195095f, 1f),
                    ["_Color5"] = new(0.8207547f, 0.6521561f, 0.5768512f, 1f),
                    ["_Color6"] = new(0.9811321f, 0.4069164f, 0.3100747f, 1f),
                    ["_Color7"] = new(0.7547169f, 0.1830218f, 0.08187964f, 1f),
                    ["_Color8"] = new(1f, 1f, 1f, 1f),
                    ["_ColorF"] = new(0.75f, 0.75f, 0.75f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_LocalPos"] = new(196.5235f, 3.715548f, 39.00184f, 0f),
                    ["_PlanetPos"] = new(0f, 0f, 0f, 0f),
                    ["_PlanetRadius"] = new(200f, 197.48f, 270f, 0f),
                    ["_Sky0"] = new(1f, 0.4374347f, 0.3058822f, 0.1607843f),
                    ["_Sky1"] = new(0.8301887f, 0.5208257f, 0.5956718f, 0.09803922f),
                    ["_Sky2"] = new(1f, 0.5187412f, 0.4103773f, 0.7490196f),
                    ["_Sky3"] = new(0.7924528f, 0.5868636f, 0.6128866f, 0.7764706f),
                    ["_Sky4"] = new(1f, 0.7566933f, 0.3427217f, 1f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_AtmoDensity"] = 1f,
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(0.8117647f, 0.3544552f, 0.1411764f, 0.7137255f),
                    ["_ColorBio0"] = new(0.3962264f, 0.08584323f, 0.03551085f, 0f),
                    ["_ColorBio1"] = new(0.2452829f, 0.0266109f, 0.0266109f, 0f),
                    ["_ColorBio2"] = new(0.3882353f, 0.2941177f, 0.2941176f, 0f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_HeightSettings"] = new(-2.6f, -2f, 1f, 0.1f),
                    ["_RimColor"] = new(0.6037736f, 0.1518671f, 0.05980769f, 1f),
                    ["_ShoreLineColor"] = new(1f, 0.5998349f, 0.2028302f, 1f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 3f,
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_AmbientColor"] = new(0.09456214f, 0.1019983f, 0.2358491f, 1f),
                    ["_Color"] = new(1f, 0.3901146f, 0.117647f, 0.5529412f),
                    ["_ColorBio0"] = new(0.235294f, 0.1645803f, 0.1595294f, 0f),
                    ["_ColorBio1"] = new(0.3499999f, 0.2344036f, 0.2344036f, 0f),
                    ["_ColorBio2"] = new(0.3779999f, 0.3225137f, 0.3641284f, 0.01960784f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ["_FlowColor"] = new(0.7924528f, 0.7924528f, 0.7924528f, 0.7882353f),
                    ["_HeightSettings"] = new(-3f, 0f, 1f, 0f),
                    ["_HoloColor"] = new(0.3f, 0.7f, 0.25f, 0.2f),
                    ["_NotVisibleColor"] = new(0f, 0.03f, 0.07499998f, 0.2f),
                    ["_RimColor"] = new(0.5566037f, 0.4371345f, 0.4122018f, 1f),
                    ["_Rotation"] = new(0.2484018f, 0.8877195f, 0.2692202f, -0.2788749f),
                    ["_ShoreLineColor"] = new(0.5568628f, 0.407498f, 0.2494745f, 1f),
                    ["_SpecularColor"] = new(0.5188679f, 0.3004048f, 0.1737718f, 1f),
                    ["_Spot0"] = new(0.6f, -0.3f, -0.5f, 1f),
                    ["_SunDir"] = new(0.2099585f, -0.006163432f, -0.9776909f, 0f)
                },
                Params = new Dictionary<string, float>
                {
                    ["_BioStrength"] = 2f,

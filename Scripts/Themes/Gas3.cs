...
namespace GalacticScale
{
    ...
    {
        public static GSTheme Gas3 = new()
        {
            Name = "GasGiant3",
            Base = true,
            ...
            atmosphereMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color0"] = new(0.7921569f, 0.439838f, 0.3843137f, 1f),
                    ["_Color1"] = new(0.8f, 0.5698366f, 0.4941176f, 1f),
                    ["_Color2"] = new(0.7921569f, 0.6024006f, 0.5254902f, 1f),
                    ["_Color3"] = new(0.7450981f, 0.5429098f, 0.4823529f, 1f),
                    ["_Color4"] = new(0.9890897f, 0.7606286f, 0.4265787f, 1f),
                    ["_Color5"] = new(0f, 0f, 0f, 1f),
                    ["_Color6"] = new(0.05699679f, 0f, 0.1415094f, 1f),
            ...
            minimapMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ["_Color"] = new(1f, 0.71988f, 0.682353f, 1f),
                    ["_ColorBio0"] = new(1f, 0.6617956f, 0.6078432f, 1f),
                    ...
                    ["_RimColor"] = new(1f, 0.5157562f, 0.3921568f, 1f),
            ...
            thumbMaterial = new GSMaterialSettings
            {
                Colors = new Dictionary<string, Color>
                {
                    ...
                    ["_Color"] = new(1f, 0.7151759f, 0.6556604f, 1f),
                    ["_ColorBio0"] = new(1f, 0.5789151f, 0.4669811f, 1f),
                    ["_ColorBio1"] = new(0.8018868f, 0.345823f, 0.2912512f, 1f),
                    ["_ColorBio2"] = new(1f, 0.677347f, 0.6273585f, 1f),
                    ["_EmissionColor"] = new(0f, 0f, 0f, 1f),
                    ...
                    ["_RimColor"] = new(1f, 0.5140815f, 0.3921568f, 1f),
                    ["_Rotation"] = new(0f, 0f, 0f, 1f),
                    ["_ShoreLineColor"] = new(0f, 0f, 0f, 0f),

    ...
    public partial class GS3Generator : iConfigurableGenerator
    {
        ...
        public static void SetupBaseThemes()
        {
            ...
            foreach (var v in ThemeLibrary.Vanilla())
            {
                ...
                //GS3.Log("Adding Theme " + clone.Name + " themeCount:" + newLibrary.Count);
                newLibrary.Add(v.Key, clone);
            }

            baseKeys = new string[newLibrary.Keys.Count];
            //GS3.Warn(newLibrary.Count.ToString());
            newLibrary.Keys.CopyTo(baseKeys, 0);
            //foreach (var k in baseKeys) GS3.Log("BaseKey:" +k);
            //foreach (var old in GS3.ThemeLibrary)
            //{
            //    GSTheme newTheme = old.Value.Clone();
            //    newTheme.Name += "_";
            //    GS3.Log($"Cloned {old.Key} to {newTheme.Name}");
            ...
            for (var i = 0; i < newLibrary.Count; i++)
            {
                ...
                theme.VeinSettings.Algorithm = "GS3";
                if (theme.Algo == 7) theme.VeinSettings.Algorithm = "GS3W";
                ...
                if (theme.PlanetType != EPlanetType.Gas && theme.PlanetType != EPlanetType.Ocean)
                {
                    ...
                    {
                        // GS3.Warn($"RENAME {smolTheme.DisplayName} {smolTheme.DisplayName.Substring(smolTheme.DisplayName.Length - 3)}");
                        smolTheme.DisplayName = smolTheme.DisplayName.Substring(0, smolTheme.DisplayName.Length - 3) + "smol";
                    }

                    smolTheme.Name += "smol";
                    smolTheme.VeinSettings.Algorithm = "GS3W";
            ...
            // GS3.WarnJson(GS3.externalThemes.Select(o=>o.Key).ToList());
            newLibrary.AddRange(GS3.externalThemes);
            GSSettings.ThemeLibrary = newLibrary;
            // GS3.Warn("End of Themes.CS, ThemeLibrary Contents:");
            // GS3.WarnJson(GSSettings.ThemeLibrary.Select(o=>o.Key).ToList());
        }
        ...
        public static void InitThemes()
        {
            ...
            moltenworld.VeinSettings.Algorithm = "GS3W";
            ...
            // obsidian.AmbientSettings.CubeMap = "GS3";
            ...
            //GS3.Log("About to Process redIce");
            var iceMalusol = new GSTheme("IceMalusol", "Ice Malusol".Translate(), "IceGelisol");
            iceMalusol.Temperature = -3;
            iceMalusol.terrainMaterial.Textures.Add("_BioTex0A", "GS3|red-ice");
            iceMalusol.terrainMaterial.Textures.Add("_BioTex1A", "GS3|grey-rock");
            iceMalusol.terrainMaterial.Textures.Add("_BioTex2A", "GS3|grey-snow");
            iceMalusol.AmbientSettings.Reflections = new Color(1, 0, 0, 1);
            iceMalusol.AmbientSettings.CubeMap = "GS3";
            ...
            iceMalusmol.VeinSettings.Algorithm = "GS3W";
            ...
            acidGreenhouse.VeinSettings.Algorithm = "GS3";
            acidGreenhouse.CustomGeneration = true;
            ...
            barrenSatellite.VeinSettings.Algorithm = "GS3";
            ...
            comet.VeinSettings.Algorithm = "GS3";
            ...
            for (var c = 11; c <= 14; c++)
            {
                ...
                cometVariant.VeinSettings.VeinTypes.Add(GSVeinType.Generate((EVeinType)c, 2, 4, 1, 2, 8, 14, false));

...
{
    public partial class GS3Generator
    {
        ...
        public void Import(GSGenPreferences importedPreferences)
        {
            ...
            for (var i = 0; i < 14; i++)
            {
                ...
                // GS3.Warn($"{importedPreferences.GetInt("OcountBias",30)}");
            ...
            // GS3.Warn($"Imported:{importedPreferences.GetInt($"OcountBias")}");
            // GS3.Warn($"Prefs:{importedPreferences.GetInt($"OcountBias")}");
        ...
        private GSOptions CreateGalaxyOptions()
        {
            ...
            UI.Add("starSizeMulti", gOptions.Add(GSUI.Slider("Star Size Multiplier".Translate(), 0.5f, 5f, 20, 0.5f, "starSizeMulti", null, "GS3 uses 10x as standard. They just look cooler.".Translate())));
            ...
            else
            {
                ...
                for (var i = 0; i < starFreq.Count; i++)
                    if (choice < starFreq.ElementAt(i).Value)
                    {
                        ...
                        //GS3.Warn($"Picked Startype {starType} with choice {choice} and value {starFreq.ElementAt(i).Value}");
                        break;
                    }
            }

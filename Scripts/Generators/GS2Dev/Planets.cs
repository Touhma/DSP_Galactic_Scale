...
namespace GalacticScale.Generators
{
    public partial class GS2Generator2 : iConfigurableGenerator
    {
        ...
        {
            foreach (var p in birthStar.Planets)
            {
        ...
        private void GeneratePlanetsForStar(GSStar star)
        {
            ...
            if (star == birthStar)
            {
                birthPlanet = star.Planets.Add(new GSPlanet("BirthPlanet", "Mediterranean",
                    preferences.GetInt("birthPlanetSize", 200), -1, -1, -1, -1, -1, -1, -1, -1, new GSPlanets()));

        ...
        public static void LoadPlugins()
        {
            ...
            foreach (var filePath in Directory.GetFiles(Path.Combine(DataDir, "Plugins")))
            {
                ...
                catch (Exception e)
                {
                    ...
                    updateMessage += $"Failed to load plugin:{filePath}\r\nIf you have recently upgraded GS3, Please check to see if an updated build of the plugin is available, or downgrade GS3 to continue using it\r\n";
                }
            }
        ...
        public static void LoadGenerators()
        {
            ...
            foreach (var filePath in Directory.GetFiles(Path.Combine(DataDir, "Generators")))
            {
                ...
                catch (Exception e)
                {
                    ...
                    updateMessage += $"Failed to load external generator:{filePath}\r\nIf you have recently upgraded GS3, Please check to see if an updated build of the generator is available, or downgrade GS3 to continue using it\r\n";
                }
            }
